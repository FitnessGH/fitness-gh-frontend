...
export default function AdminMarketplacePage() {
  return (
    <div className="p-6 space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-foreground">Marketplace Oversight</h1>
        <p className="text-muted-foreground">Monitor marketplace activity and disputes</p>
      </div>
      ...
      <Card className="p-6 border-border/50">
        <h2 className="text-lg font-semibold mb-4 text-foreground">Recent Disputes</h2>
        <div className="space-y-3">
          {[
            { id: "DSP-001", vendor: "Elite Supplements", issue: "Product quality complaint", status: "Open" },
            { id: "DSP-002", vendor: "Fit Gear Co", issue: "Shipping delay", status: "In Review" },
            { id: "DSP-003", vendor: "ProFit Gear", issue: "Wrong item shipped", status: "Resolved" },
          ].map((dispute, i) => (
            <div key={i} className="p-4 border border-border rounded-lg hover:border-primary/50 transition-colors">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">{dispute.vendor}</p>
                  <p className="text-sm text-foreground mt-2">{dispute.issue}</p>
                </div>
                <Badge
                  className={
                    dispute.status === "Open"
      ...
      {/* Top Vendors */}
      <Card className="p-6 border-border/50">
        <h2 className="text-lg font-semibold mb-4 text-foreground">Top Vendors</h2>
            ...
            <div key={i} className="p-4 border border-border rounded-lg">
              ...
              <div className="mt-3 space-y-2">
                <div className="flex justify-between">
                  ...
                  <p className="text-sm font-semibold text-primary">{vendor.sales}</p>
                </div>
                <div className="flex justify-between">
