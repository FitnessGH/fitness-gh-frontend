  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <Card className="p-6 border-border/50">
        <h2 className="text-lg font-semibold mb-4 text-foreground">Featured Listings</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            { name: "Protein Powder", vendor: "Elite Supplements", price: "$29.99", orders: 24 },
            { name: "Gym Bag", vendor: "Fit Gear Co", price: "$49.99", orders: 18 },
            { name: "Water Bottle", vendor: "HydroMax", price: "$24.99", orders: 32 },
          ].map((product, i) => (
            <div key={i} className="p-4 border border-border rounded-lg hover:border-primary/50 transition-colors">
              <div className="flex items-start justify-between mb-3">
                ...
                <span className="text-xs bg-primary/10 text-primary px-2 py-1 rounded">{product.orders} orders</span>
              </div>
