...
const mockNotifications: Notification[] = [
  {
    ...
    message: "Alex Chen's membership is expiring on 2025-03-15. Send renewal reminder?",
    date: "2025-01-16",
    read: false,
  },
  {
  ...
  },
  {
    ...
    message: "Payment from Maria Garcia for Standard plan failed. Please retry.",
    date: "2025-01-15",
    read: true,
  },
  {
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">View membership renewals, events, and important alerts</p>
      </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between mb-1">
                  ...
                  {!notification.read && <CheckCircle className="w-4 h-4 text-primary" />}
                </div>
