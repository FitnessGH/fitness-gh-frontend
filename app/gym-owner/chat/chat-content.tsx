...
const mockMessages: Message[] = [
  {
    id: "M001",
    author: "You",
    content: "Welcome to our gym community group! Looking forward to connecting with all members.",
    timestamp: "10:00 AM",
    isOwn: true,
  },
  {
    id: "M002",
    author: "Alex Chen",
    content: "Thanks for creating this space! Excited to be part of the community.",
    timestamp: "10:05 AM",
    isOwn: false,
  },
  {
...
export default function ChatPageContent() {
  const [selectedGroup, setSelectedGroup] = useState<ChatGroup | null>(mockChatGroups[0])
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-foreground">Gym Chat & Messaging</h1>
          <p className="text-muted-foreground">Communicate with members and send group invites</p>
        </div>
              ...
              <div className="flex-1 space-y-4 overflow-y-auto mb-4">
                {messages.map((msg) => (
                  <div key={msg.id} className={`flex ${msg.isOwn ? "justify-end" : "justify-start"}`}>
                    ...
                    >
                      {!msg.isOwn && <p className="text-xs font-semibold mb-1">{msg.author}</p>}
