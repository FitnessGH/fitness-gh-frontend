...
import { Bell, Lock, User, DollarSign, ImageIcon, Upload } from "lucide-react"
      ...
      <Card className="p-6 border-border/50 space-y-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <Input id="gymName" placeholder="Your gym name" defaultValue="FitClub Downtown" />
          </div>
          <div>
            <Label htmlFor="email">Email</Label>
            <Input id="email" type="email" placeholder="Email" defaultValue="owner@fitclub.com" />
          </div>
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Input id="website" placeholder="Website" defaultValue="fitclub.com" />
            </div>
          </div>
        ...
        <div className="space-y-4">
          <div className="border-2 border-dashed border-border/50 rounded-lg p-8 text-center cursor-pointer hover:border-primary/50 transition-colors">
            ...
            <label htmlFor="imageUpload" className="cursor-pointer block">
              ...
              <p className="text-sm text-foreground font-medium">Click to upload gym images</p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {uploadedImages.map((img, i) => (
                  <div key={i} className="relative rounded-lg overflow-hidden bg-muted">
                    <img src={img || "/placeholder.svg"} alt={`Gym ${i + 1}`} className="w-full h-32 object-cover" />
                    <button
          ...
          <Button className="bg-primary hover:bg-primary/90 w-full">Save Images</Button>
        </div>
      </Card>
