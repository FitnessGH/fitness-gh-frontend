...
import { Clock, CheckCircle2, AlertCircle, LogOut } from "lucide-react"
        ...
        <div className="min-h-screen bg-gradient-to-br from-background to-secondary/10 flex items-center justify-center p-6">
            <Card className="max-w-md w-full p-8 text-center space-y-6 border-0 shadow-2xl">
                ...
                <div className="space-y-2">
                    <h1 className="text-3xl font-bold tracking-tight">Approval in Progress</h1>
                    <p className="text-muted-foreground">
                        Thanks for submitting your gym details, <strong>{user?.name}</strong>! Our admins are currently reviewing your application.
                    </p>
                </div>
                ...
                <div className="bg-muted/50 rounded-xl p-4 text-left space-y-3">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">Successfully registered as a gym owner</p>
                        </div>
                    </div>
                    <div className="flex items-start gap-3">
                        <CheckCircle2 className="w-5 h-5 text-green-500 mt-0.5" />
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">Wait for our team to verify your business license</p>
                        </div>
                    </div>
                    <div className="flex items-start gap-3 opacity-50">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">You will gain access to the dashboard once approved</p>
                        </div>
                    </div>
                </div>
