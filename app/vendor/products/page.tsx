...
const mockProducts: Product[] = [
  ...
  { id: "3", name: "BCAA Energy Drink", category: "Supplements", price: 14.99, stock: 0, sales: 178, status: "Active" },
  {
    id: "4",
          ...
          <tbody>
            {filteredProducts.map((product) => (
              <tr key={product.id} className="border-b border-border/50 hover:bg-muted/30">
                ...
                <td className="py-3 px-4 text-primary font-semibold">${product.price.toFixed(2)}</td>
                <td className="py-3 px-4">
                  <span
                ...
                <td className="py-3 px-4">
                  <div className="flex items-center justify-center gap-2">
                    ...
                    <button className="p-1 hover:bg-muted rounded" title="Toggle visibility">
