      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Track your personal fitness objectives
          </p>
        </div>
      ...
      <Card className="p-6 border-border/50">
        ...
        <div className="space-y-3">
          {[
            ...
            {
              tip: 'Hydration',
              advice: 'Drink at least 8-10 glasses of water throughout the day',
            },
            {
              tip: 'Meal Timing',
              advice: 'Eat a balanced meal 2-3 hours before your workout',
            },
            {
              tip: 'Recovery Nutrition',
              advice: 'Consume carbs and protein within 30 mins after workout',
            },
          ].map((item, i) => (
            <div
              key={i}
