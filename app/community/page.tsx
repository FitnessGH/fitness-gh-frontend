...
const mockPosts: Post[] = [
  {
    ...
    group: 'Workout Tips',
    content:
      'Just completed my first 5K run without stopping! 7 months of consistent training paid off!',
    timestamp: '2h ago',
    likes: 24,
    replies: 5,
    image: '🏃',
  },
  {
    ...
    content:
      "New spinning class starting next Monday at 6 PM! Who's interested?",
    timestamp: '4h ago',
    likes: 18,
    replies: 3,
  },
  {
    ...
    content:
      'Share your favorite post-workout meal ideas! I need some inspiration.',
    timestamp: '6h ago',
    likes: 42,
    replies: 12,
    image: '🍽️',
  },
  {
    ...
    content:
      'Looking for someone to do morning gym sessions with starting Feb 1st!',
    timestamp: '1d ago',
    likes: 15,
    replies: 7,
  },
...
function CommunityContent() {
  ...
  const filteredPosts = selectedGroup
    ? mockPosts.filter((post) => post.group === selectedGroup)
    : mockPosts;
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Connect with gym members and share your fitness journey
            </p>
          </div>
